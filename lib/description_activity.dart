...
class DescriptionActivity extends StatefulWidget {
  const DescriptionActivity({Key? key}) : super(key: key);

  @override
  State<DescriptionActivity> createState() => _DescriptionActivityState();
}
bool isFileExits=false;
bool isLoading=false;
class _DescriptionActivityState extends State<DescriptionActivity> {
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    //width: MediaQuery.of(context).size.width,
                    color: Colors.white,
                    child: isLoading?Center(child: CircularProgressIndicator(),):Center(child: Text(isFileExits?"PlayBook":"Download",style: TextStyle(color: Colors.black))),
                  ),
                ),
                InkWell(
                  onTap: (){
